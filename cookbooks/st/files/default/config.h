 ...
 */
//static char font[] = "Inconsolata XL:pixelsize=16:style=medium:antialias=true,PowerlineSymbols";
static char font[] = "Pragmata:pixelsize=16:weight=medium:antialias=true";
